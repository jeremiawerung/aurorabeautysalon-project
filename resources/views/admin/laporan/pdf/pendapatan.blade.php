...
<body>
  ...
  {{-- ============================================================
       ZONA 5: TABEL RANGKUMAN / SUMMARY
       - Tambah/hapus <tr> → tambah/hapus baris summary
       - Ubah style="width:auto" → lebar tabel summary
       - Ubah class "mt-16" → jarak atas summary ke tabel data
       - Data dari variabel $summary (array dari controller)
       ============================================================ --}}
  ...
  {{-- ============================================================
       ZONA 6: FOOTER (Belum ada — tambahkan di sini jika diminta)
