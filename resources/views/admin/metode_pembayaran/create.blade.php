...
@section('title', 'Tambah Metode Pembayaran - Aurora')

@section('content')
<style>
    /* Style card dan form (sama seperti halaman lainnya) */
    .card {
        ...
        <form action="{{ route('metode-pembayaran.store') }}" method="POST">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex flex-column flex-md-row justify-content-md-between align-items-start align-items-md-center">
                    <h5 class="mb-2 mb-md-0">Form Tambah Metode Pembayaran</h5>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <textarea id="keterangan" name="keterangan" class="form-control" rows="5"
                                      placeholder="Tulis keterangan singkat (misal: hanya untuk pembayaran di kasir)...">{{ old('keterangan') }}</textarea>
                        </div>
                    </div>
                </div>
