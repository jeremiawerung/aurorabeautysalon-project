                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <select id="durasi" name="durasi" class="form-control" required style="border-right: 0;">
                                    <option value="15" {{ old('durasi') == 15 ? 'selected' : '' }}>15 Menit</option>
                                    <option value="30" {{ old('durasi') == 30 ? 'selected' : '' }}>30 Menit</option>
                                    <option value="45" {{ old('durasi') == 45 ? 'selected' : '' }}>45 Menit</option>
                                    <option value="60" {{ old('durasi') == 60 ? 'selected' : '' }}>60 Menit</option>
                                    <option value="90" {{ old('durasi') == 90 ? 'selected' : '' }}>90 Menit</option>
                                    <option value="120" {{ old('durasi') == 120 ? 'selected' : '' }}>120 Menit</option>
                                </select>
